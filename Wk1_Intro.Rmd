...
For everyone to have a great learning experience, we would like to ask you follow the following ground rules for this course

* *Please leave your camera on during the tutorials*.<br> Teaching, interacting with others, and active participation profit immensely from being able to see the faces and reactions of the people one is interacting with. Thus, we ask you to turn on your cameras during the tutorial. We advise you to use a background so that your private quarters are hidden from others while still being accessible and able to actively participating in the course. 

* *Please do not hesitate to get in touch if you have any questions*.<br> You can contact us anytime via email and in the drop-in sessions that are offered in case you have questions or issues that you would like to discuss with the teaching staff.

* *Please submit your assignments in time or apply for an extension before the due date*.<br>In case you cannot submit an assignment in time, please apply for an extension before the due date and submit the necessary documents alongside the application for an extension (all documents must be in English or an official translation).
